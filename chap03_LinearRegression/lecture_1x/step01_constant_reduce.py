...
f = tf.range(10, 1.5, -2.5) # (start, step, delta)
print(f) # [10.   7.5  5.   2.5]
...
[[5 5 5]
 [5 5 5]]
'''
print(tf.reduce_sum(c, axis=0)) # 행축 합계:열 단위 - [10 10 10] 
print(tf.reduce_sum(c, axis=1)) # 열축 합계:행 단위 - [15 15]
